               ...
               <!--  <table width="100%" border="0" cellspacing="0" class="StationDetails">
                ...
                <table width="100%" border="0" cellspacing="0" class="StationDetails">
                    ...
                    <tr bgcolor="#34495e" style="border-top:1px solid #FFFFFF;color:#F3F3F3;font-weight:bold;">
                        <td " bgcolor="#23365e">
                            <font size="4px">City</font>
                        </td>
                        <td " bgcolor="#23365e">
                            <font size="4px">MinTemp</font>
                        </td>
                        <td " bgcolor="#23365e">
                            <font size="4px">MaxTemp</font>
                        </td>
                        <td " bgcolor="#23365e">
                            <font size="4px">Humidity</font>
                        </td>
                        <td " bgcolor="#23365e">
                            <font size="4px">Weight</font>
                        </td>
                    </tr>
                    <?php
...
/*$stmt = "SELECT $MinTemp, $MaxTemp, $Temp9am, $Temp3pm, $Cloud9am, $Cloud3pm, 
   ...
   ";*/
    $stmt = 'SELECT name, round(MINT,5), round(MAXT,5), round(H,5), round((MINT + MAXT + H),5) "weights" from
    (select name, 0.25*(avg(mintemp)-20)/20 MINT, 0.25*(avg(maxtemp)-26)/26 MAXT, 
                  0.5*(avg(humidity_3pm)-45)/45 H
     from (select * from location natural join humidity_note natural join temperature_note
           where extract(year from location.dates)=2013)
     group by name)
